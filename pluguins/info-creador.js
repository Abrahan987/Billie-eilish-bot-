...
let biografia = await conn.fetchStatus('573237649689' +'@s.whatsapp.net').catch(_ => 'Sin Biografía')
...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `Abrahan-m`, dev, correo, `🇨🇴 Colombia`, `${global.yt}`, bio],
